...
PRODUCT_COPY_FILES += \
    ...
    vendor/lava/irsx1/proprietary//vendor/lib/libWVStreamControlAPI_L3.so:system//vendor/lib/libWVStreamControlAPI_L3.so \
    vendor/lava/irsx1/proprietary//vendor/media/LMspeed_508.emd:system//vendor/media/LMspeed_508.emd \
    vendor/lava/irsx1/proprietary//vendor/media/PFFprec_600.emd:system//vendor/media/PFFprec_600.emd \
    vendor/lava/irsx1/proprietary//vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors7./left_eye-y0-yi45-p0-pi45-r0-ri20.lg_32.bin:system//vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors7./left_eye-y0-yi45-p0-pi45-r0-ri20.lg_32.bin \
    vendor/lava/irsx1/proprietary//vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/nose_base-y0-yi45-p0-pi45-r0-ri20.lg_32.bin:system//vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/nose_base-y0-yi45-p0-pi45-r0-ri20.lg_32.bin \
    vendor/lava/irsx1/proprietary//vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/right_eye-y0-yi45-p0-pi45-r0-ri20.lg_32-2.bin:system//vendor/pittpatt/models/detection/multi_pose_face_landmark_detectors.7/right_eye-y0-yi45-p0-pi45-r0-ri20.lg_32-2.bin \
    vendor/lava/irsx1/proprietary//vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-r0-ri30.4a-v24.bin:system//vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-r0-ri30.4a-v24.bin \
    vendor/lava/irsx1/proprietary//vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rn30-ri30.5-v24.bin:system//vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rn30-ri30.5-v24.bin \
    vendor/lava/irsx1/proprietary//vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rp30-ri30.5-v24.bin:system//vendor/pittpatt/models/detection/yaw_roll_face_detectors.6/head-y0-yi45-p0-pi45-rp30-ri30.5-v24.bin \
    vendor/lava/irsx1/proprietary//vendor/pittpatt/models/recognition/face.face.y0-y0-22-b-N.bin:system//vendor/pittpatt/models/recognition/face.face.y0-y0-22-b-N.bin \
    vendor/lava/irsx1/proprietary//etc/bluetooth/auto_pair_devlist.conf:system//etc/bluetooth/auto_pair_devlist.conf \
    vendor/lava/irsx1/proprietary//etc/bluetooth/bt_did.conf:system//etc/bluetooth/bt_did.conf \
    vendor/lava/irsx1/proprietary//etc/bluetooth/bt_stack.conf:system//etc/bluetooth/bt_stack.conf \
    vendor/lava/irsx1/proprietary//etc/bluetooth/bt_vendor.conf:system//etc/bluetooth/bt_vendor.conf \
    vendor/lava/irsx1/proprietary//etc/gps/glconfig.xml:system//etc/gps/glconfig.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.bluetooth_le.xml:system//etc/permissions/android.hardware.bluetooth_le.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.camera.flash-autofocus.xml:system//etc/permissions/android.hardware.camera.flash-autofocus.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.camera.front.xml:system//etc/permissions/android.hardware.camera.front.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.location.gps.xml:system//etc/permissions/android.hardware.location.gps.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.sensor.barometer.xml:system//etc/permissions/android.hardware.sensor.barometer.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.sensor.gyroscope.xml:system//etc/permissions/android.hardware.sensor.gyroscope.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.sensor.light.xml:system//etc/permissions/android.hardware.sensor.light.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.sensor.proximity.xml:system//etc/permissions/android.hardware.sensor.proximity.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.telephony.gsm.xml:system//etc/permissions/android.hardware.telephony.gsm.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.touchscreen.multitouch.distinct.xml:system//etc/permissions/android.hardware.touchscreen.multitouch.distinct.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.usb.accessory.xml:system//etc/permissions/android.hardware.usb.accessory.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.usb.host.xml:system//etc/permissions/android.hardware.usb.host.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.wifi.direct.xml:system//etc/permissions/android.hardware.wifi.direct.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.hardware.wifi.xml:system//etc/permissions/android.hardware.wifi.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.software.live_wallpaper.xml:system//etc/permissions/android.software.live_wallpaper.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.software.sip.voip.xml:system//etc/permissions/android.software.sip.voip.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/android.software.sip.xml:system//etc/permissions/android.software.sip.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/com.android.location.provider.xml:system//etc/permissions/com.android.location.provider.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/com.android.media.remotedisplay.xml:system//etc/permissions/com.android.media.remotedisplay.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/com.broadcom.bt.xml:system//etc/permissions/com.broadcom.bt.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/com.google.android.maps.xml:system//etc/permissions/com.google.android.maps.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/com.google.android.media.effects.xml:system//etc/permissions/com.google.android.media.effects.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/com.google.widevine.software.drm.xml:system//etc/permissions/com.google.widevine.software.drm.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/handheld_core_hardware.xml:system//etc/permissions/handheld_core_hardware.xml \
    vendor/lava/irsx1/proprietary//etc/permissions/platform.xml:system//etc/permissions/platform.xml \
    vendor/lava/irsx1/proprietary//etc/wifi/wpa_supplicant.conf:system//etc/wifi/wpa_supplicant.conf \
    vendor/lava/irsx1/proprietary//etc/asound.conf:system//etc/asound.conf \
    vendor/lava/irsx1/proprietary//etc/atx_rndis.conf:system//etc/atx_rndis.conf \
    vendor/lava/irsx1/proprietary//etc/audio_effects.conf:system//etc/audio_effects.conf \
    vendor/lava/irsx1/proprietary//etc/audio_policy.conf:system//etc/audio_policy.conf \
    vendor/lava/irsx1/proprietary//etc/clatd.conf:system//etc/clatd.conf \
    vendor/lava/irsx1/proprietary//etc/copy_ap_files.sh:system//etc/copy_ap_files.sh \
    vendor/lava/irsx1/proprietary//etc/copy_cp_imgs.sh:system//etc/copy_cp_imgs.sh \
    vendor/lava/irsx1/proprietary//etc/default_mode.sh:system//etc/default_mode.sh \
    vendor/lava/irsx1/proprietary//etc/dnsmasq.conf:system//etc/dnsmasq.conf \
    vendor/lava/irsx1/proprietary//etc/gps.conf:system//etc/gps.conf \
    vendor/lava/irsx1/proprietary//etc/hosts:system//etc/hosts \
    vendor/lava/irsx1/proprietary//etc/init_sensors.sh:system//etc/init_sensors.sh \
    vendor/lava/irsx1/proprietary//etc/mkshrc:system//etc/mkshrc \
    vendor/lava/irsx1/proprietary//etc/netconsole.sh:system//etc/netconsole.sh \
    vendor/lava/irsx1/proprietary//etc/performance_mode.sh:system//etc/performance_mode.sh \
    vendor/lava/irsx1/proprietary//etc/sdp_charger.sh:system//etc/sdp_charger.sh \
    vendor/lava/irsx1/proprietary//etc/udhcpd.conf:system//etc/udhcpd.conf \
    vendor/lava/irsx1/proprietary//etc/udhcpd_ncm.conf:system//etc/udhcpd_ncm.conf \
    vendor/lava/irsx1/proprietary//etc/usbdev.sh:system//etc/usbdev.sh \
    vendor/lava/irsx1/proprietary//etc/usb_network.sh:system//etc/usb_network.sh \
    vendor/lava/irsx1/proprietary//etc/usb_portd.conf:system//etc/usb_portd.conf \
    vendor/lava/irsx1/proprietary//etc/usb_save.sh:system//etc/usb_save.sh \
    vendor/lava/irsx1/proprietary//etc/usb_tether.sh:system//etc/usb_tether.sh \
    vendor/lava/irsx1/proprietary//usr/keychars/Generic.kcm:system//usr/keychars/Generic.kcm \
    vendor/lava/irsx1/proprietary//usr/keychars/java.kcm:system//usr/keychars/java.kcm \
    vendor/lava/irsx1/proprietary//usr/keychars/qwerty.kcm:system//usr/keychars/qwerty.kcm \
    vendor/lava/irsx1/proprietary//usr/keychars/qwerty2.kcm:system//usr/keychars/qwerty2.kcm \
    vendor/lava/irsx1/proprietary//usr/keychars/Virtual.kcm:system//usr/keychars/Virtual.kcm \
    vendor/lava/irsx1/proprietary//usr/AVRCP.kl:system//usr/AVRCP.kl \
    vendor/lava/irsx1/proprietary//usr/Generic.kl:system//usr/Generic.kl \
    vendor/lava/irsx1/proprietary//usr/java.kl:system//usr/java.kl \
    vendor/lava/irsx1/proprietary//usr/qwerty.kl:system//usr/qwerty.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_0079_Product_0011.kl:system//usr/Vendor_0079_Product_0011.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_045e_Product_028e.kl:system//usr/Vendor_045e_Product_028e.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_046d_Product_c216.kl:system//usr/Vendor_046d_Product_c216.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_046d_Product_c219.kl:system//usr/Vendor_046d_Product_c219.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_046d_Product_c21f.kl:system//usr/Vendor_046d_Product_c21f.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_046d_Product_c294.kl:system//usr/Vendor_046d_Product_c294.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_046d_Product_c299.kl:system//usr/Vendor_046d_Product_c299.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_046d_Product_c532.kl:system//usr/Vendor_046d_Product_c532.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_054c_Product_0268.kl:system//usr/Vendor_054c_Product_0268.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_0583_Product_2060.kl:system//usr/Vendor_0583_Product_2060.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_05ac_Product_0239.kl:system//usr/Vendor_05ac_Product_0239.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_1038_Product_1412.kl:system//usr/Vendor_1038_Product_1412.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_12bd_Product_d015.kl:system//usr/Vendor_12bd_Product_d015.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_1689_Product_fd00.kl:system//usr/Vendor_1689_Product_fd00.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_1689_Product_fd01.kl:system//usr/Vendor_1689_Product_fd01.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_1689_Product_fe00.kl:system//usr/Vendor_1689_Product_fe00.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_1bad_Product_f016.kl:system//usr/Vendor_1bad_Product_f016.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_1bad_Product_f023.kl:system//usr/Vendor_1bad_Product_f023.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_1bad_Product_f027.kl:system//usr/Vendor_1bad_Product_f027.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_1bad_Product_f036.kl:system//usr/Vendor_1bad_Product_f036.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_1d79_Product_0009.kl:system//usr/Vendor_1d79_Product_0009.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_22b8_Product_093d.kl:system//usr/Vendor_22b8_Product_093d.kl \
    vendor/lava/irsx1/proprietary//usr/Vendor_2378_Product_100a.kl:system//usr/Vendor_2378_Product_100a.kl
